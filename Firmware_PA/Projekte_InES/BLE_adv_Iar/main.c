...
static inline void initIO(void) {
  ...
  HWREG(IOC_BASE + 4*IO_A ) = (IOC_STD_INPUT& (~IOC_NO_IOPULL)) | IOC_IOPULL_UP | IOC_HYST_ENABLE;
  HWREG(IOC_BASE + 4*IO_B) =  (IOC_STD_INPUT& (~IOC_NO_IOPULL)) | IOC_IOPULL_UP | IOC_HYST_ENABLE;
  HWREG(IOC_BASE + 4*IO_C) =  (IOC_STD_INPUT& (~IOC_NO_IOPULL)) | IOC_IOPULL_UP | IOC_HYST_ENABLE;
  HWREG(IOC_BASE + 4*IO_D) =  (IOC_STD_INPUT& (~IOC_NO_IOPULL)) | IOC_IOPULL_UP | IOC_HYST_ENABLE;
  HWREG(IOC_BASE + 4*IO_E) =  (IOC_STD_INPUT& (~IOC_NO_IOPULL)) | IOC_IOPULL_UP | IOC_HYST_ENABLE;
